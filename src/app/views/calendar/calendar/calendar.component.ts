...
import { CalendarAppEvent } from 'models/calendar-event.model';
...
export class CalendarComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private calendarService: CalendarAppService) {
    this.actions = [
      {
  ...
  public removeEvent(event) {
    this.modalService
      .open(this.eventDeleteConfirm, { ariaLabelledBy: 'modal-basic-title', centered: true })
      .result.then(
        result => {
